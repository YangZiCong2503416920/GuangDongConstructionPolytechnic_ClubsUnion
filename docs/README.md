...
- **更新日期**: 2026-01-15
- **主要更新**:
  - 项目整理：合并 v1.0 原型、清理 IDE 文件与 framework 死代码、压缩媒体资源
  - 修复全部断链（register.html 大小写、原型导航等），补充缺失的模块导出
  - 新增注册/找回密码表单交互、关于页动画、原型社团详情模态框/分类筛选/轮播暂停控制
  - 全部页面补充 meta description，支持 GitHub Pages 部署
  - 历史版本更新请查看 CHANGELOG.md
